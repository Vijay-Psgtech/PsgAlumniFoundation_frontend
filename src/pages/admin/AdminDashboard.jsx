...
const AdminDashboard = () => {
  ...
  const [stats, setStats] = useState({ totalAlumni: 0, pendingAlumni: 0, totalDonatedAmount: 0, completedDonations: 0 });
      ...
      try {
        ...
        const [statsRes, alumniRes, donationsRes] = await Promise.all([
          adminAPI.getStats().catch(err => {
            ...
            return { data: { stats: { totalAlumni: 0, pendingAlumni: 0, totalDonatedAmount: 0, completedDonations: 0 } } };
          }),
