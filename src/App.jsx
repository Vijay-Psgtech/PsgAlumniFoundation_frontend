...
import { DataProvider } from "./context/DataContext"; // ✅ ADDED
...
export default function App() {
  return (
    // ✅ DataProvider wraps everything so all pages share the same
    //    events/albums state. AuthProvider stays outermost so
    //    useAuth() works inside DataProvider too if ever needed.
    <DataProvider>
      <AuthProvider>
        <BrowserRouter>
          <AppRoutes />
