      ...
      <div className="vals-inner">
        ...
        <motion.div className="vals-footer" initial={{opacity:0,y:24}} whileInView={{opacity:1,y:0}} transition={{duration:.75,delay:.2}} viewport={{once:true}}>
          <p className="vals-footer-text">
            "These core values form the Association of everything we do — ensuring that our <strong>actions align with our mission</strong> to support PSG Tech's excellence and development."
          </p>
        </motion.div>
      </div>
    </section>
